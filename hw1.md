...
**Assigned date:** Sept. 26, 2018

**Due date:** Oct 2. You have 1 week for this homework.

**Questions:** Make sure your post them on the [discussion board](https://piazza.com/washington/fall2018/cse414).
...
`https://gitlab.cs.washington.edu/cse414-2018au/cse414-[your CSE username]`. 
...
$ git clone git@gitlab.cs.washington.edu:cse414-2018au/cse414-[your CSE username].git
...
repository `cse414-2018au`.  In `git` parlance, this "original repository" referred to as an `upstream` repository.
...
$ git remote add upstream git@gitlab.cs.washington.edu:maas/cse414-2018au.git
```
...
```sh
$ git remote -v
  origin  git@gitlab.cs.washington.edu:cse414-2018au/cse414-[your CSE username].git (fetch)
  origin  git@gitlab.cs.washington.edu:cse414-2018au/cse414-[your CSE username].git (push)
  upstream    git@gitlab.cs.washington.edu:maas/cse414-2018au.git (fetch)
  upstream    git@gitlab.cs.washington.edu:maas/cse414-2018au.git (push)
```
...
To git@gitlab.cs.washington.edu:cse414-2018au/cse414-[your CSE username].git
...
To git@gitlab.com:cse414-2018au/cse414-[your CSE username].git
 - [deleted]         hw1
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse414-2018au/cse414-[your CSE username].git confirmation_directory
